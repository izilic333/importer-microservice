...
Revision ID: 11d2d8427621
Revises: 7477cb758cea
Create Date: 2021-05-16 00:56:44.842295
...
revision = '11d2d8427621'
down_revision = '7477cb758cea'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('administration_importtype_id_seq'::regclass)"), nullable=False),
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('administration_importerftpconfiguration_id_seq'::regclass)"), nullable=False),
    sa.Column('name', sa.VARCHAR(length=255), autoincrement=False, nullable=False),
    sa.Column('url', sa.VARCHAR(length=255), autoincrement=False, nullable=False),
    sa.Column('username', sa.VARCHAR(length=50), autoincrement=False, nullable=False),
    sa.Column('password', sa.VARCHAR(length=120), autoincrement=False, nullable=False),
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('events_id_seq'::regclass)"), nullable=False),
    sa.Column('alive', sa.BOOLEAN(), autoincrement=False, nullable=False),
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('time_period_id_seq'::regclass)"), nullable=False),
    sa.Column('alive', sa.BOOLEAN(), autoincrement=False, nullable=False),
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('time_interval_id_seq'::regclass)"), nullable=False),
    sa.Column('alive', sa.BOOLEAN(), autoincrement=False, nullable=False),
    sa.Column('start_time', postgresql.TIME(), autoincrement=False, nullable=False),
    sa.Column('end_time', postgresql.TIME(), autoincrement=False, nullable=False),
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('combo_recipes_id_seq'::regclass)"), nullable=False),
    sa.Column('alive', sa.BOOLEAN(), autoincrement=False, nullable=False),
    sa.Column('code', sa.VARCHAR(length=30), autoincrement=False, nullable=False),
    sa.Column('caption', sa.VARCHAR(length=100), autoincrement=False, nullable=False),
    sa.Column('product_id', sa.INTEGER(), autoincrement=False, nullable=False),
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('djcelery_workerstate_id_seq'::regclass)"), nullable=False),
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('date_period_id_seq'::regclass)"), nullable=False),
    sa.Column('alive', sa.BOOLEAN(), autoincrement=False, nullable=False),
    sa.Column('start_date', sa.DATE(), autoincrement=False, nullable=False),
    sa.Column('end_date', sa.DATE(), autoincrement=False, nullable=False),
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('external_cashless_references_id_seq'::regclass)"), nullable=False),
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('transaction_tenders_id_seq'::regclass)"), nullable=False),
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('skill_levels_id_seq'::regclass)"), nullable=False),
    sa.Column('name', sa.VARCHAR(length=30), autoincrement=False, nullable=False),
    sa.Column('company_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('alive', sa.BOOLEAN(), server_default=sa.text('true'), autoincrement=False, nullable=False),
