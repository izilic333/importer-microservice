...
Revision ID: e01ad0d304ec
Revises: 9507d0a75360
Create Date: 2021-05-16 00:51:50.962851
...
revision = 'e01ad0d304ec'
down_revision = '9507d0a75360'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('machine_product_components_id_seq'::regclass)"), nullable=False),
    sa.Column('alive', sa.BOOLEAN(), autoincrement=False, nullable=False),
