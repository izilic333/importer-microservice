...
Revision ID: dd273900daa9
Revises: 11d2d8427621
Create Date: 2021-05-16 00:59:12.997542
...
revision = 'dd273900daa9'
down_revision = '11d2d8427621'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('cleaning_report_log_id_seq'::regclass)"), nullable=False),
    sa.Column('alive', sa.BOOLEAN(), server_default=sa.text('true'), autoincrement=False, nullable=False),
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('commission_group_id_seq'::regclass)"), nullable=False),
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('route_routemachineproduct_id_seq'::regclass)"), nullable=False),
